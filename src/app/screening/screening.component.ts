...
export class ScreeningComponent implements OnInit { 
  ...
  //idNumPattern="[0-9][0-9]{1}|0[0]"+"(0[1-9]|1[0-2])"+"(0[1-9]|[12][0-9]|3[0-1])"+"[1-9]{1}"+"[0-9]{4}"+"[7-9]{1}"+"[0-9]{1}";
  idNumPattern="[0-9][0-9]{1}"+"(0[1-9]|1[0-2])"+"(0[1-9]|[12][0-9]|3[0-1])"+"[0-9]{5}"+"[7-9]{1}"+"[0-9]{1}";
